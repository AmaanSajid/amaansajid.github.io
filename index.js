...
import { URLs } from './user-data/urls.js';
  portfolio/index.js
  const { LLMProjects, MLProjects, PythonProjects, CloudProjects } =
    projects;
  ...
  populateProjects(LLMProjects, "LLM-projects");
  populateProjects(MLProjects, "ML/DL-projects");
  populateProjects(PythonProjects, "Python-projects");
  populateProjects(CloudProjects, "Cloud-projects");
